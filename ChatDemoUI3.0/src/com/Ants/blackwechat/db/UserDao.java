 ...
 */
package com.Ants.blackwechat.db;
...
public class UserDao {
    ...
    public void saveAppContact(User user) {
        DemoDBManager.getInstance().saveAppContact(user);
    }


    public Map<String, User> getAppContactList() {

        return DemoDBManager.getInstance().getAppContactList();
    }

    public void saveAppContactList(List<User> contactList) {
        DemoDBManager.getInstance().saveAppContactList(contactList);
    }
}
