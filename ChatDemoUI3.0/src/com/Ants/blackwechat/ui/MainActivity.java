...
import com.Ants.blackwechat.adapter.MainTabAdpter;
import com.Ants.blackwechat.db.InviteMessgeDao;
import com.Ants.blackwechat.db.UserDao;
import com.Ants.blackwechat.runtimepermissions.PermissionsManager;
import com.Ants.blackwechat.runtimepermissions.PermissionsResultAction;
import com.Ants.blackwechat.widget.DMTabHost;
import com.Ants.blackwechat.widget.MFViewPager;
 ...
 * <p>
 * get unread event notification count, including application, accepted, etc
 * @return get unread message count
 * @return show the dialog when user met some exception: such as login on another device, user removed or user forbidden
 * <p>
 * debug purpose only, you can ignore this
 * <p>
 * check if current user account was remove
